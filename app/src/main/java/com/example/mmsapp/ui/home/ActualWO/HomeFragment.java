...
import com.example.mmsapp.ui.home.Composite.ItemCompositeAdapter;
...
/////
    ...
    private void getData(int page) {
        new getData().execute(webUrl+ "ActualWO/Getdataw_actual_primary?rows=50&page="+ page+"&sidx=&sord=asc");
        Log.e("getData",webUrl+ "ActualWO/Getdataw_actual_primary?rows=50&page="+ page+"&sidx=&sord=asc");
    }
    ...
    private void getaddData(int page) {
        new getaddData().execute(webUrl+ "ActualWO/Getdataw_actual_primary?rows=50&page="+ page+"&sidx=&sord=asc");
        Log.e("getaddData",webUrl+ "ActualWO/Getdataw_actual_primary?rows=50&page="+ page+"&sidx=&sord=asc");
    }
