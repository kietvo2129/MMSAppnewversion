package com.example.mmsapp.ui.home.Mapping.QCcheck;
...
public class QCCheckActivity extends AppCompatActivity {
    ...
    int numgr_qty = MappingActivity.numgr_qty;
    ...
    private void getdatadetail() {
        new getdatadetail().execute(webUrl + "ActualWO/Getfacline_qc?mt_cd=" + MappingActivity.Ml_no +"&item_vcd="+ManufacturingActivity.qc_code);
    }
        ...
        if (tv_qcheck_checkqty.getText().toString().equals("0")) {
            ...
            if (tv_qcheck_defectqty.getText().toString().trim().equals("0")) {
                ...
                new saveQC().execute(webUrl+"ActualWO/Insert_FaclineQc_API?icdno=" + "" + "&check_qty="+ tv_qcheck_checkqty.getText().toString().trim()
                        + "&check_qty_error="+ "" + "&ok_qty="+ tv_qcheck_okcheck.getText().toString().trim() + "&item_vcd="+ ManufacturingActivity.qc_code + "&mt_cd="+MappingActivity.Ml_no);
                ...
                if (ITEM_ICDNO_S.length() > 1 && ITEM_CHECK_ERR_S.length() > 1) {
                    ...
                    new saveQC().execute(webUrl+"ActualWO/Insert_FaclineQc_API?icdno=" + ITEM_ICDNO_S + "&check_qty="+ tv_qcheck_checkqty.getText().toString().trim()
                            + "&check_qty_error="+ ITEM_CHECK_ERR_S + "&ok_qty="+ tv_qcheck_okcheck.getText().toString().trim() + "&item_vcd="+ ManufacturingActivity.qc_code + "&mt_cd="+MappingActivity.Ml_no);
